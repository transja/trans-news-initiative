...
<style lang="scss">
	:global {
		/* Style for Dropdown Triggers */
		.filter-control__input[data-bits-dropdown-menu-trigger] {
		...
		/* --- Styles for DateRangeField --- */
		[data-bits-date-range-field-input] {
			justify-content: flex-start;
		}

		[data-bits-date-field-segment] {
			padding: 0 0.1rem;
			border-radius: 0.125rem;
			caret-color: transparent;
		}

		[data-bits-date-field-segment]:focus {
			color: #ffffff;
			background-color: #3b82f6;
			outline: none;
		}

		[data-bits-date-field-segment][data-placeholder] {
			color: #6b7280;
		}
